...
Fixed for matplotlib compatibility
"""
...
# ============================================================
# FIXED Arrow3D class for matplotlib compatibility
# ============================================================
...
def create_frame(composite_idx):
    ...
    # Plot stability tubes (simplified - use plot3D instead of tubes)
    rho_tube = tubes['rho']
...
def create_pulse_frame(t, scale):
    """Create a pulsating frame."""
    final_idx = len(composites) - 1
    c = composites[final_idx]
    tubes = tubes_per_epoch[final_idx]
    logic = logic_maps[final_idx]
    ...
    # Subsample logic shell for performance
...
for t in tqdm(range(pulse_total_frames), desc="Pulsating frames"):
    ...
    img = create_pulse_frame(t, scale)
