# ============================================================
# CONDORBRAIN GPU BACKTEST - 20k SAMPLES (QUICK CHECK)
# ============================================================
print("🚀 Starting CondorBrain GPU Backtest (20k Samples)...")
...
with torch.no_grad():
    for start in tqdm(range(0, SAMPLE_SIZE, BATCH_SIZE), desc="Inference"):
        ...
        # AMP for speed on T4 (Mixed Precision) - Corrected Syntax
