...
CONFIG = {
    ...
    "margin_pct":         0.4371,        # Max % of buying power to deploy per trade
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      785.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.3726,  # Target |delta| for short (selling) strikes
