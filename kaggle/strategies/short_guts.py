...
CONFIG = {
    ...
    "margin_spot_pct":    0.25,      # If pct_spot: margin = spot * this * 100
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      300,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.3410,  # Target |delta| for short (selling) strikes
