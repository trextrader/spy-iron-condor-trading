"""
strangle_long.py — Strangle Long
===================================
...
WHAT IT IS:
    Buy OTM put + OTM call. Cheaper than straddle but needs bigger move to profit.
...
RISK PROFILE:
    ...
    Reward: Unlimited — needs breakout past either strike.

WHEN IT FIRES (predicate atoms):
    bw_expanding & ~ivr_high & breakout_any & friction_ok
...
CONFIG = {
    ...
    "call_offset_pct":    2.0586,  # % OTM for call strike (None = neural model)
    "put_offset_pct":     2.0905,  # % OTM for put strike  (None = neural model)
