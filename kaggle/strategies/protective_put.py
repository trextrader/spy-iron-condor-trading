...
CONFIG = {
    ...
    "margin_pct":         0.6011,        # Max % of buying power to deploy per trade
    "margin_type":        "pct_spot",   # "width" (spread) or "pct_spot" (naked)
    "margin_spot_pct":    0.0999,      # If pct_spot: margin = spot * this * 100
    ...
    "spread_width":       20,  # Spread width points   (None = neural model / N/A)
    ...
    "short_delta":        0.2351,  # Target |delta| for short (selling) strikes
