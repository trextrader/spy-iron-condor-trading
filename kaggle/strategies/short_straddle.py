...
CONFIG = {
    ...
    "stop_loss_dollar":   550,  # Hard dollar cap per trade (None = use multiplier only)

    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      800,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.4139,  # Target |delta| for short (selling) strikes
