...
CONFIG = {
    ...
    "margin_pct":         0.2418,        # Max % of buying power to deploy per trade
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      850.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.1752,  # Target |delta| for short (selling) strikes
