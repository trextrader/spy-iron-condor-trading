...
CONFIG = {
    ...
    "margin_pct":         0.2994,        # Max % of buying power to deploy per trade
    ...
    # ── Position Limits ───────────────────────────────────────────────────
    "max_positions":      13,           # Max concurrent open positions for this strategy
    ...
    "short_delta":        0.1688,  # Target |delta| for short (selling) strikes
