...
CONFIG = {
    ...
    "margin_pct":         0.4129,        # Max % of buying power to deploy per trade
    ...
    "stop_loss_dollar":   510.0000,  # Hard dollar cap per trade (None = use multiplier only)

    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2085.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.1849,  # Target |delta| for short (selling) strikes
