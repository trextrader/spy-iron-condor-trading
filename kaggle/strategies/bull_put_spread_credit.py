...
CONFIG = {
    ...
    "margin_pct":         0.5058,        # Max % of buying power to deploy per trade
    ...
    "max_leg_spread":     0.1981,  # Max bid-ask ratio per leg

    # ── Entry: Delta Targets (template path) ────────────────────────────────
    "short_delta":        0.4239,  # Target |delta| for short (selling) strikes
