...
CONFIG = {
    ...
    "margin_pct":         0.3269,        # Max % of buying power to deploy per trade
    ...
    "spread_width":       7.5000,  # Spread width points   (None = neural model / N/A)
    ...
    "short_delta":        0.1718,  # Target |delta| for short (selling) strikes
