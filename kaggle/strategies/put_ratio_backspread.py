...
CONFIG = {
    ...
    "margin_pct":         0.5463,        # Max % of buying power to deploy per trade
    ...
    "short_delta":        0.2892,  # Target |delta| for short (selling) strikes
    "wing_delta":         0.3,  # Target |delta| for long wing strikes (None = N/A)
