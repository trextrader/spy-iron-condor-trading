...
CONFIG = {
    ...
    "margin_pct":         0.5119,        # Max % of buying power to deploy per trade
    ...
    "stop_loss_dollar":   1450.0000,  # Hard dollar cap per trade (None = use multiplier only)
    ...
    "short_delta":        0.3846,  # Target |delta| for short (selling) strikes
