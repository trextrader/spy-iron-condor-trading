...
CONFIG = {
    ...
    "stop_loss_dollar":   1225,  # Hard dollar cap per trade (None = use multiplier only)

    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2150,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.3608,  # Target |delta| for short (selling) strikes
