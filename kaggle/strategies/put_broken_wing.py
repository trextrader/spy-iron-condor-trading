...
CONFIG = {
    ...
    "stop_loss_dollar":   450,  # Hard dollar cap per trade (None = use multiplier only)

    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2750,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.2128,  # Target |delta| for short (selling) strikes
