...
CONFIG = {
    ...
    "margin_pct":         0.5000,        # Max % of buying power to deploy per trade
    ...
    "stop_loss_dollar":   475.0000,  # Hard dollar cap per trade (None = use multiplier only)
    ...
    "call_offset_pct":    1.7000,  # % OTM for call strike (None = neural model)
    ...
    "short_delta":        0.2733,  # Target |delta| for short (selling) strikes
    "wing_delta":         0.1777,  # Target |delta| for long wing strikes (None = N/A)
