...
CONFIG = {
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2300,    # Dollar target (None = use 50% of credit)
    ...
    "spread_width":       15,  # Spread width points   (None = neural model / N/A)
    ...
    "short_delta":        0.3699,  # Target |delta| for short (selling) strikes
