...
CONFIG = {
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2600.0000,    # Dollar target (None = use 50% of credit)
    ...
    "cooldown_bars":      11,           # Min bars between trades
    ...
    "short_delta":        0.3897,  # Target |delta| for short (selling) strikes
