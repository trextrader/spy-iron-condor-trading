...
CONFIG = {
    ...
    "margin_pct":         0.7000,        # Max % of buying power to deploy per trade
    ...
    "cooldown_bars":      26,           # Min bars between trades
    ...
    "short_delta":        0.1945,  # Target |delta| for short (selling) strikes
