...
CONFIG = {
    ...
    "stop_loss_dollar":   800.0000,  # Hard dollar cap per trade (None = use multiplier only)
    ...
    "cooldown_bars":      9,           # Min bars between trades
    ...
    "short_delta":        0.3204,  # Target |delta| for short (selling) strikes
    "wing_delta":         0.1122,  # Target |delta| for long wing strikes (None = N/A)
