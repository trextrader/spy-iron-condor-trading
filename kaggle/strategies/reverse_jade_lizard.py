...
CONFIG = {
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1450.0000,    # Dollar target (None = use 50% of credit)
    ...
    "call_offset_pct":    1.4000,  # % OTM for call strike (None = neural model)
    ...
    "short_delta":        0.3385,  # Target |delta| for short (selling) strikes
