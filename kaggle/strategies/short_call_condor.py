...
CONFIG = {
    ...
    "spread_width":       15.0000,  # Spread width points   (None = neural model / N/A)
    ...
    "short_delta":        0.3432,  # Target |delta| for short (selling) strikes
    "wing_delta":         0.1134,  # Target |delta| for long wing strikes (None = N/A)
