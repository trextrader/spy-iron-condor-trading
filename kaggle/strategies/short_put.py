...
CONFIG = {
    ...
    "margin_pct":         0.5258,        # Max % of buying power to deploy per trade
    "margin_type":        "pct_spot",   # "width" (spread) or "pct_spot" (naked)
    "margin_spot_pct":    0.0811,      # If pct_spot: margin = spot * this * 100
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1150.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.2471,  # Target |delta| for short (selling) strikes
