...
CONFIG = {
    ...
    "margin_pct":         0.5270,        # Max % of buying power to deploy per trade
    ...
    "stop_loss_dollar":   600.0000,  # Hard dollar cap per trade (None = use multiplier only)
    ...
    "short_delta":        0.3071,  # Target |delta| for short (selling) strikes
