"""
long_put_condor.py — Long Put Condor
=======================================
...
WHAT IT IS:
    Put-side rangebound debit. Mirror of long call condor.
...
CONFIG = {
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1250.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.4379,  # Target |delta| for short (selling) strikes
