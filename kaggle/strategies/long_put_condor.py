...
CONFIG = {
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1385.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.3697,  # Target |delta| for short (selling) strikes
    "wing_delta":         0.2990,  # Target |delta| for long wing strikes (None = N/A)
