...
CONFIG = {
    ...
    "margin_pct":         0.5410,        # Max % of buying power to deploy per trade
    "margin_type":        "width",   # "width" (spread) or "pct_spot" (naked)
    "margin_spot_pct":    0.4271,      # If pct_spot: margin = spot * this * 100
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1550.0000,    # Dollar target (None = use 50% of credit)
    ...
    "spread_width":       19.0000,  # Spread width points   (None = neural model / N/A)
    ...
    "short_delta":        0.4316,  # Target |delta| for short (selling) strikes
    "wing_delta":         0.3255,  # Target |delta| for long wing strikes (None = N/A)
