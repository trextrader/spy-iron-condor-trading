...
CONFIG = {
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2475,    # Dollar target (None = use 50% of credit)
    ...
    "spread_width":       14,  # Spread width points   (None = neural model / N/A)
    ...
    "short_delta":        0.3688,  # Target |delta| for short (selling) strikes
