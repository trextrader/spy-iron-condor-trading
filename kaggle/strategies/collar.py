...
CONFIG = {
    ...
    "margin_pct":         0.5697,        # Max % of buying power to deploy per trade
    "margin_type":        "pct_spot",   # "width" (spread) or "pct_spot" (naked)
    "margin_spot_pct":    0.0000,      # If pct_spot: margin = spot * this * 100
    ...
    "short_delta":        0.2702,  # Target |delta| for short (selling) strikes
