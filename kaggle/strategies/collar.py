...
CONFIG = {
    ...
    "margin_pct":         0.4697,        # Max % of buying power to deploy per trade
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2850.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.2388,  # Target |delta| for short (selling) strikes
