...
CONFIG = {
    ...
    "margin_pct":         0.4770,        # Max % of buying power to deploy per trade
    ...
    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      2250.0000,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.3532,  # Target |delta| for short (selling) strikes
