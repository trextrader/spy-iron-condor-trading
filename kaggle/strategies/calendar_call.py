...
CONFIG = {
    ...
    "margin_pct":         0.2975,        # Max % of buying power to deploy per trade
    "margin_type":        "pct_spot",   # "width" (spread) or "pct_spot" (naked)
    "margin_spot_pct":    0.2225,      # If pct_spot: margin = spot * this * 100
    ...
    "max_leg_spread":     0.1228,  # Max bid-ask ratio per leg
