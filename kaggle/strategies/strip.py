...
CONFIG = {
    ...
    "stop_loss_dollar":   490.0000,  # Hard dollar cap per trade (None = use multiplier only)

    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1685.0000,    # Dollar target (None = use 50% of credit)
    ...
    # ── Position Limits ───────────────────────────────────────────────────
    "max_positions":      10,           # Max concurrent open positions for this strategy
    ...
    "short_delta":        0.3849,  # Target |delta| for short (selling) strikes
