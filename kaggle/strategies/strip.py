...
CONFIG = {
    ...
    "margin_pct":         0.4271,        # Max % of buying power to deploy per trade
    "margin_type":        "pct_spot",   # "width" (spread) or "pct_spot" (naked)
    "margin_spot_pct":    0.0149,      # If pct_spot: margin = spot * this * 100
    ...
    "max_leg_spread":     0.0743,  # Max bid-ask ratio per leg

    # ── Entry: Delta Targets (template path) ────────────────────────────────
    "short_delta":        0.2578,  # Target |delta| for short (selling) strikes
