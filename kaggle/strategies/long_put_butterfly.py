...
CONFIG = {
    ...
    "margin_pct":         0.3106,        # Max % of buying power to deploy per trade
    ...
    "spread_width":       9.5000,  # Spread width points   (None = neural model / N/A)
    ...
    "short_delta":        0.3790,  # Target |delta| for short (selling) strikes
