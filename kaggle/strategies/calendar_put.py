...
WHAT IT IS:
    Put-side calendar spread. Same mechanics as call calendar.

LEG STRUCTURE:
#   Leg 1: SHORT P rank0 [near DTE]
#   Leg 2: LONG P rank0 [far DTE]

RISK PROFILE:
    Risk:   Limited to net debit paid.
    Reward: Profits from near option decaying faster.
...
CONFIG = {
    ...
    "margin_pct":         0.5902,        # Max % of buying power to deploy per trade
    "margin_type":        "pct_spot",   # "width" (spread) or "pct_spot" (naked)
    "margin_spot_pct":    0.1926,      # If pct_spot: margin = spot * this * 100
    ...
    "cooldown_bars":      32,           # Min bars between trades
    ...
    "max_leg_spread":     0.1687,  # Max bid-ask ratio per leg
