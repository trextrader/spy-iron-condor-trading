...
CONFIG = {
    ...
    "margin_pct":         0.5437,        # Max % of buying power to deploy per trade
    ...
    "stop_loss_dollar":   1050.0000,  # Hard dollar cap per trade (None = use multiplier only)
    ...
    "short_delta":        0.2429,  # Target |delta| for short (selling) strikes
