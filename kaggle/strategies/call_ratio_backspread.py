...
CONFIG = {
    ...
    "stop_loss_dollar":   1300,  # Hard dollar cap per trade (None = use multiplier only)

    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1550,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.4047,  # Target |delta| for short (selling) strikes
