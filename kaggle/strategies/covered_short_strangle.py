...
CONFIG = {
    ...
    "stop_loss_dollar":   800,  # Hard dollar cap per trade (None = use multiplier only)

    # ── Exit: Profit Target ───────────────────────────────────────────────
    "profit_target":      1450,    # Dollar target (None = use 50% of credit)
    ...
    "short_delta":        0.3734,  # Target |delta| for short (selling) strikes
