...
from .canonical_feature_registry import FEATURE_COLS_V22, FEATURE_COLS_V30, FEATURE_COLS_V42
...
class FieldType(IntEnum):
    """All available fields from V4.2 schema."""
    # Enumerated dynamically from FEATURE_COLS_V42
    pass


# Build field enum dynamically (V4.2: 91 fields)
ALL_FIELDS: List[str] = FEATURE_COLS_V42.copy()
