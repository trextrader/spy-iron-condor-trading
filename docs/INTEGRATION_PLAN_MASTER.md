...
- Use **implicit** (backward Euler) or **Crankâ€“Nicolson** to ensure stability in diffusion terms.
...
We **avoid explicit** schemes for production diagnostics. Use implicit/Crankâ€“Nicolson to remove CFL constraints and guarantee stability.
...
## 29) Additional Graphviz: Datafeed â†’ Sizing Benchmark Output
